...
<template>
  <div class="w-full h-full flex flex-col justify-center items-center relative p-10 lg:p-[60px] bg-white text-neutral-900 dark:bg-neutral-900 dark:text-neutral-50">
    <!-- Gradient background -->
    ...
    <div class="relative flex flex-col items-center text-center gap-5 lg:gap-8">
      ...
      <div class="items-center justify-center w-full">
        <!-- Title -->
        <h1 class="text-[48px] lg:text-[80px] font-bold m-0 leading-tight max-w-[700px] lg:max-w-[1000px]" style="display: block; line-clamp: 3; text-overflow: ellipsis; text-wrap: balance;">
          {{ title }} - Ejected!
        </h1>
      </div>
